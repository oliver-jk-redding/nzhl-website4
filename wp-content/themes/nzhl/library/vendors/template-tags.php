 ...
 */
	function some_like_it_neat_posted_on() {
		...
		printf( __( '<span class="posted-on" itemprop="datePublished" >Posted on %1$s</span><span class="byline" itemscope itemtype="http://schema.org/Person"> <span itemprop="author" > </span></span>', 'some-like-it-neat' ),
