 ...
 *
 * @wordpress-plugin
 * Plugin Name:       ATI Latest News
 * Plugin URI:        http://drewlondon.co.uk
 * Description:       ATI 'Latest News' Widget for Sidebaer
 * Version:           1.0.0
 * Author:            Drew London
...
class ATI_Latest_News extends WP_Widget {
    /**
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'ATI_Latest_News', $this->get_widget_slug() ),
			array(
	...
	public function widget( $args, $instance ) {
		...
		query_posts('category_name=News&orderby=date&order=DESC&posts_per_page=1');
...
add_action( 'widgets_init', create_function( '', 'register_widget("ATI_Latest_News");' ) );
