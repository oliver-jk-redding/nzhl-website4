 ...
 *
 * @package   NZHL Painting Comp Winner
 ...
 *
 * @wordpress-plugin
 * Plugin Name:       NZHL Painting Comp Winner
 * Plugin URI:        http://oliverredding.com
 * Description:       NZHL Painting Comp Winner Widget for Sidebar
 * Version:           1.0.0
...
class NZHL_Painting_Comp_Winner extends WP_Widget {
    /**
     ...
     * @var      string
     */
    protected $widget_slug = 'nzhl-painting-comp-winner-widget';
    /*--------------------------------------------------*/
	/* Constructor
	/*--------------------------------------------------*/
	/**
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'NZHL_Painting_Comp_Winner', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'A widget which features the winning entry of last month\'s painting competition.', $this->get_widget_slug() )
				)
			);
	...
	public function widget( $args, $instance ) {
	  ...
	  $name = $lastName ? '<span>'.$firstName.'</span>' . " " . '<span>'.$lastName.'</span>' : '<span>'.$firstName.'</span>';
		...
		$widget_string .= $widget_heading."<a class='wg-painting-comp-winner-container' href='/gallery/'>
...
add_action( 'widgets_init', create_function( '', 'register_widget("NZHL_Painting_Comp_Winner");' ) );
